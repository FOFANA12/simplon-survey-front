<template>
  <div class="card mt-4">
    ...
    <div class="w-full mx-auto bg-white shadow-sm rounded-lg">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t("companyManager.sections.personalInformation") }}
        </h2>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            <label for="first_name" class="block text-gray-700 mb-1">
              {{ t("companyManager.form.firstName") }}
            ...
            <input
              ...
              :placeholder="t('companyManager.form.firstNamePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            <label for="last_name" class="block text-gray-700 mb-1">
              {{ t("companyManager.form.lastName") }}
              <span class="text-red-500 text-md">*</span>
            </label>
            <input
              id="last_name"
              ...
              type="text"
              class="w-full p-2 border rounded-lg"
              :placeholder="t('companyManager.form.lastNamePlaceholder')"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            ...
            <input
              ...
              type="email"
              class="w-full p-2 border rounded-lg"
              :placeholder="t('companyManager.form.emailPlaceholder')"
              aria-label="Email"
            />
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            ...
            <input
              ...
              type="text"
              class="w-full p-2 border rounded-lg"
              :placeholder="t('companyManager.form.phonePlaceholder')"
              aria-label="Phone"
            />
          ...
          <!-- Company -->
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            <label for="company" class="block text-gray-700 mb-1">
              {{ t("companyManager.form.company") }}
              <span class="text-red-500 text-md">*</span>
            </label>
            <v-select
              ...
              value="uuid"
              :reduce="(o) => o.uuid"
              :placeholder="t('companyManager.form.companyPlaceholder')"
            />
            <HasError
              :form="form"
              field="company"
          ...
          <div class="col-span-12 md:col-span-6 md:mt-4 flex items-center mb-4">
            <input
              id="is_company_main_contact"
              type="checkbox"
              v-model="form.is_company_main_contact"
              class="checkbox checkbox-primary mr-2"
            />
            <label for="is_company_main_contact" class="text-gray-700">
              {{ t("companyManager.form.isCompanyMainContact") }}
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="w-full mx-auto bg-white shadow-sm rounded-lg mt-6">
      <div class="card-header">
        <h2 class="text-xl p-4 pt-2 pb-2">
          {{ t("companyManager.sections.security") }}
        </h2>
        <hr class="border-t border-gray-200 w-full mb-0" />
      </div>
      <div class="card-body p-4">
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            <label for="password" class="block text-gray-700 mb-1">
              {{ t("companyManager.form.password") }}
            </label>
            <input
              id="password"
              ...
              class="w-full p-2 border rounded-lg"
              :placeholder="t('companyManager.form.passwordPlaceholder')"
              aria-label="Password"
            />
            <HasError
              :form="form"
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-4 mb-4">
            <label for="password_confirm" class="block text-gray-700 mb-1">
              {{ t("companyManager.form.passwordConfirm") }}
            </label>
            <input
              id="password_confirm"
              ...
              class="w-full p-2 border rounded-lg"
              :placeholder="t('companyManager.form.passwordConfirmPlaceholder')"
