  ...
  <div class="overflow-x-auto">
    ...
    >
      <template #table-row="props">
        ...
        <span v-else-if="props.column.field === 'isCompanyMainContact'">
          <div class="flex justify-center">
            <span
              :class="{
                'badge badge-success text-white p-3': props.row.isCompanyMainContact === true,
                'badge badge-error text-white p-3': props.row.isCompanyMainContact === false,
              }"
            >
              {{
                props.row.status
                  ? t("companyManager.table.isCompanyMainContactYes")
                  : t("companyManager.table.isCompanyMainContactNo")
              }}
            </span>
          </div>
        </span>
